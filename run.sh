...
# Поворот
build/main 50 0 0 0 /home/nikita_viksne/Документы/C_Cpp_progs/InertialNavigation/Data_files/data_acc_veloc_0_heading_50_freq_400_turn_V_coo_gps.csv 1 1 1 1 1 1
